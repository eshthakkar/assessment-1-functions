...
def repeat_string(repeat_string,repeat_count):
    print repeat_string * repeat_count
...
def sign_and_parity(number):
    ...
    # List that stores the parity and sign of a number
    description_list = []
